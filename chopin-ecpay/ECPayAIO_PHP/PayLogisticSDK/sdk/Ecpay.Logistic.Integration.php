...
if (! class_exists('EcpayLogisticsSubType', false)) {
    abstract class EcpayLogisticsSubType
    {
        ...
        // 黑貓(宅配)
        public const ECAN = 'ECAN';

        // 宅配通
        public const FAMILY = 'FAMI';
        ...
        // 萊爾富
        public const FAMILY_C2C = 'FAMIC2C';

        // 全家店到店
        public const UNIMART_C2C = 'UNIMARTC2C';
...
if (! class_exists('EcpayTestMerchantId', false)) {
    ...
    {
        public const B2C = '2000132';

        // B2C
        public const C2C = '2000933'; // C2C
    }
}
...
if (! class_exists('EcpayUrl', false)) {
    ...
    {
        public const CVS_MAP = 'https://logistics.ecpay.com.tw/Express/map';

        // 電子地圖
        public const SHIPPING_ORDER = 'https://logistics.ecpay.com.tw/Express/Create';

        // 物流訂單建立
        public const HOME_RETURN_ORDER = 'https://logistics.ecpay.com.tw/Express/ReturnHome';

        // 宅配逆物流訂單
        public const UNIMART_RETURN_ORDER = 'https://logistics.ecpay.com.tw/express/ReturnUniMartCVS';

        // 超商取貨逆物流訂單(統一超商B2C)
        public const HILIFE_RETURN_ORDER = 'https://logistics.ecpay.com.tw/express/ReturnHiLifeCVS';

        // 超商取貨逆物流訂單(萊爾富超商B2C)
        public const FAMILY_RETURN_ORDER = 'https://logistics.ecpay.com.tw/express/ReturnCVS';

        // 超商取貨逆物流訂單(全家超商B2C)
        public const FAMILY_RETURN_CHECK = 'https://logistics.ecpay.com.tw/Helper/LogisticsCheckAccoounts';

        // 全家逆物流核帳(全家超商B2C)
        public const UNIMART_UPDATE_LOGISTICS_INFO = 'https://logistics.ecpay.com.tw/Helper/UpdateShipmentInfo';

        // 統一修改物流資訊(全家超商B2C)
        public const UNIMART_UPDATE_STORE_INFO = 'https://logistics.ecpay.com.tw/Express/UpdateStoreInfo';

        // 更新門市(統一超商C2C)
        public const UNIMART_CANCEL_LOGISTICS_ORDER = 'https://logistics.ecpay.com.tw/Express/CancelC2COrder';

        // 取消訂單(統一超商C2C)
        public const QUERY_LOGISTICS_INFO = 'https://logistics.ecpay.com.tw/Helper/QueryLogisticsTradeInfo/V2';

        // 物流訂單查詢
        public const PRINT_TRADE_DOC = 'https://logistics.ecpay.com.tw/helper/printTradeDocument';

        // 產生托運單(宅配)/一段標(超商取貨)
        public const PRINT_UNIMART_C2C_BILL = 'https://logistics.ecpay.com.tw/Express/PrintUniMartC2COrderInfo';

        // 列印繳款單(統一超商C2C)
        public const PRINT_FAMILY_C2C_BILL = 'https://logistics.ecpay.com.tw/Express/PrintFAMIC2COrderInfo';

        // 全家列印小白單(全家超商C2C)
        public const Print_HILIFE_C2C_BILL = 'https://logistics.ecpay.com.tw/Express/PrintHILIFEC2COrderInfo';

        // 萊爾富列印小白單(萊爾富超商C2C)
        public const CREATE_TEST_DATA = 'https://logistics.ecpay.com.tw/Express/CreateTestData'; // 產生 B2C 測標資料
    }
}
...
if (! class_exists('EcpayTestUrl', false)) {
    ...
    {
        public const CVS_MAP = 'https://logistics-stage.ecpay.com.tw/Express/map';

        // 電子地圖
        public const SHIPPING_ORDER = 'https://logistics-stage.ecpay.com.tw/Express/Create';

        // 物流訂單建立
        public const HOME_RETURN_ORDER = 'https://logistics-stage.ecpay.com.tw/Express/ReturnHome';

        // 宅配逆物流訂單
        public const UNIMART_RETURN_ORDER = 'https://logistics-stage.ecpay.com.tw/express/ReturnUniMartCVS';

        // 超商取貨逆物流訂單(統一超商B2C)
        public const HILIFE_RETURN_ORDER = 'https://logistics-stage.ecpay.com.tw/express/ReturnHiLifeCVS';

        // 超商取貨逆物流訂單(萊爾富超商B2C)
        public const FAMILY_RETURN_ORDER = 'https://logistics-stage.ecpay.com.tw/express/ReturnCVS';

        // 超商取貨逆物流訂單(全家超商B2C)
        public const FAMILY_RETURN_CHECK = 'https://logistics-stage.ecpay.com.tw/Helper/LogisticsCheckAccoounts';

        // 全家逆物流核帳(全家超商B2C)
        public const UNIMART_UPDATE_LOGISTICS_INFO = 'https://logistics-stage.ecpay.com.tw/Helper/UpdateShipmentInfo';

        // 統一修改物流資訊(全家超商B2C)
        public const UNIMART_UPDATE_STORE_INFO = 'https://logistics-stage.ecpay.com.tw/Express/UpdateStoreInfo';

        // 更新門市(統一超商C2C)
        public const UNIMART_CANCEL_LOGISTICS_ORDER = 'https://logistics-stage.ecpay.com.tw/Express/CancelC2COrder';

        // 取消訂單(統一超商C2C)
        public const QUERY_LOGISTICS_INFO = 'https://logistics-stage.ecpay.com.tw/Helper/QueryLogisticsTradeInfo/V2';

        // 物流訂單查詢
        public const PRINT_TRADE_DOC = 'https://logistics-stage.ecpay.com.tw/helper/printTradeDocument';

        // 產生托運單(宅配)/一段標(超商取貨)
        public const PRINT_UNIMART_C2C_BILL = 'https://logistics-stage.ecpay.com.tw/Express/PrintUniMartC2COrderInfo';

        // 列印繳款單(統一超商C2C)
        public const PRINT_FAMILY_C2C_BILL = 'https://logistics-stage.ecpay.com.tw/Express/PrintFAMIC2COrderInfo';

        // 全家列印小白單(全家超商C2C)
        public const Print_HILIFE_C2C_BILL = 'https://logistics-stage.ecpay.com.tw/Express/PrintHILIFEC2COrderInfo';

        // 萊爾富列印小白單(萊爾富超商C2C)
        public const CREATE_TEST_DATA = 'https://logistics-stage.ecpay.com.tw/Express/CreateTestData'; // 產生 B2C 測標資料
    }
}
...
if (! class_exists('EcpayTemperature', false)) {
    ...
    {
        public const ROOM = '0001';

        // 常溫
        public const REFRIGERATION = '0002';

        // 冷藏
        public const FREEZE = '0003'; // 冷凍
    }
}
...
if (! class_exists('EcpayDistance', false)) {
    ...
    {
        public const SAME = '00';

        // 同縣市
        public const OTHER = '01';

        // 外縣市
        public const ISLAND = '02'; // 離島
    }
}
...
if (! class_exists('EcpaySpecification', false)) {
    ...
    {
        public const CM_60 = '0001';

        // 60cm
        public const CM_90 = '0002';

        // 90cm
        public const CM_120 = '0003';

        // 120cm
        public const CM_150 = '0004'; // 150cm
    }
}
...
if (! class_exists('EcpayScheduledPickupTime', false)) {
    ...
    {
        public const TIME_9_12 = '1';

        // 9~12時
        public const TIME_12_17 = '2';

        // 12~17時
        public const TIME_17_20 = '3';

        // 17~20時
        public const UNLIMITED = '4'; // 不限時
    }
}
...
if (! class_exists('EcpayScheduledDeliveryTime', false)) {
    abstract class EcpayScheduledDeliveryTime
    {
        ...
        // 17~20時
        public const UNLIMITED = '4';

        // 不限時
        public const TIME_20_21 = '5';

        // 20~21時(需限定區域)
        public const TIME_9_17 = '12';

        // 早午 9~17
        public const TIME_9_12_17_20 = '13';

        // 早晚 9~12 & 17~20
        public const TIME_13_20 = '23'; // 午晚 13~20
    }
}
...
if (! class_exists('EcpayStoreType', false)) {
    ...
    {
        public const RECIVE_STORE = '01';

        // 取件門市
        public const RETURN_STORE = '02'; // 退件門市
    }
}
...
if (! class_exists('EcpayLogistics', false)) {
    class EcpayLogistics
    {
         ...
         * 版本
         */
        public const VERSION = '1.1.2002120';
        ...
        public function IsLegal($Name, $Value)
        {
            ...
            // 檢查是否為合法資料(含空值)
            if (! in_array($Value, $ContentList, true) && ! empty($Value)) {
